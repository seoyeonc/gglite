...
density <- function(y,label=NULL, ...) {
  ...
  return(do.call(ggplot2::geom_density, c(list(data = df, mapping = ggplot2::aes(x = y, fill = label, group = group, col = label), alpha = 0.25), args)))
}
...
qq <- function(y,label=NULL, ...) {
  ...
  return(do.call(ggplot2::geom_qq, c(list(data = df, mapping = ggplot2::aes(sample = y, group = group, col = label)), args)))
}
...
qq_line <- function(y,label=NULL, ...) {
  ...
  return(do.call(ggplot2::geom_qq_line, c(list(data = df, mapping = ggplot2::aes(sample = y, group = group, col = label)), args)))
}
...
col <- function(x, y=NULL,label=NULL, ...) {
  ...
  return(do.call(ggplot2::geom_col, c(list(data = df, mapping = ggplot2::aes(x = x, y = y,  group = group, fill = label), position = 'dodge'), args)))
}
...
boxplot <- function(x, y=NULL,label=NULL, ...) {
  ...
  return(do.call(ggplot2::geom_boxplot, c(list(data = df, mapping = ggplot2::aes(x = x, y = y,  group = group, col = label)), args)))
}
...
violin <- function(x, y=NULL,label=NULL, ...) {
  ...
  return(do.call(ggplot2::geom_violin, c(list(data = df, mapping = ggplot2::aes(x = x, y = y,  group = group, fill = label, color = label), alpha = 0.5, scale = 'area'), args)))
}
